# Generated by Powerlevel10k configuration wizard on 2023-06-06 at 15:14 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, vertical separators, sharp heads, flat tails, 2 lines, disconnected,
# full frame, light-ornaments, compact, many icons, concise, instant_prompt=verbose.
